package com.example.hp.stickpick.android_retrofit.activity;
...
import com.example.hp.stickpick.utils.DistanceCalculation;
                ...
                try {
                    ...
                    for (int i = 0; i < response.body().getResults().size(); i++) {
                        ...
                        mMap.addPolyline(new PolylineOptions()
                                .add(new LatLng(Double.parseDouble(HomeActivity.lats), Double.parseDouble(HomeActivity.lngs)), latLng)
                                .width(1)
                                .color(Color.RED));
                    }
