...
public class LocationService extends Service implements
    ...
    private void updateUI() {
        if (SpeedoMeterActivity.p == 0) {
            ...
            if (speed > 0.0) {
               // distance = speed * diff;
                SpeedoMeterActivity.speed.setText("Current speed: " + new DecimalFormat("#.##").format(speed + " m/s"));
            }
            else {
                SpeedoMeterActivity.speed.setText(".......");
            }

            SpeedoMeterActivity.dist.setText(new DecimalFormat("#.###").format((distance)) + " Km.");
            lStart = lEnd;
            SpeedoMeterActivity.startTime=SpeedoMeterActivity.endTime;
