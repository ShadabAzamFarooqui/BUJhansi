 ...
 */
public class MCA5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mca5, container, false);

        progressDialog = new ProgressDialog(getActivity());
        attendanceList = new ArrayList();
        getAllRecord();
        listView = view.findViewById(R.id.AttendanceMca5);
...
//                    listView.setAdapter(myAdapter);
        ...
        summit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child(ParameterConstants.ATTENDANCE_MCA_5).child("" + strDate).setValue(attendanceList, new DatabaseReference.CompletionListener() {
                    @Override
    ...
    private void collectPhoneNumbers(Map<String, Object> users) {
        ...
        for (int i = 0; i < listBean.size(); i++) {
            if (listBean.get(i).getCourse().equals("MCA") && listBean.get(i).getSemester().equals("5th")) {
