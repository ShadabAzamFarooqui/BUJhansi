package com.example.hp.stickpick.speedo_meter;
...
public class SpeedoMeterActivity extends AppCompatActivity {
    ...
    static TextView dist, time, speed,totalTravelledDistance;
...
//            moveTaskToBack(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalTravelledDistance = (TextView) findViewById(R.id.distancefinal);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status == false)
                    ...
                    bindService();
                locate = new ProgressDialog(SpeedoMeterActivity.this);
                ...
                totalTravelledDistance.setVisibility(View.GONE);
